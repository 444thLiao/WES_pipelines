...
def merge_two_vcf(pair_vcf,bed,single_vcf,output_vcf):
    ...
    cmdline1 = formatted_line.format(vcf=pair_vcf,bed=bed,output=output_vcf+'1',SM=pair_sample_name)
    cmdline2 = formatted_line.format(vcf=single_vcf,bed=bed,output=output_vcf+'2',SM=single_sample_name)
    os.system(cmdline1)
    os.system(cmdline2)
